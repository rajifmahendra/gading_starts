                ...
                @foreach($galleries as $gallery)
                    <li role="button" class="port-item mix gallery">
                        <a href="{{ $gallery->file_contents }}">
                            <div class="port-img-overlay"><img class="port-main-img" src="{{ $gallery->file_contents }}" alt="img" ></div>
                        </a>
                        <div class="port-overlay-cont">
                            <div class="port-title-cont">
{{--                                <h3><a href="{{ $gallery->file_contents }}">MINIMALISM BOOKS</a></h3>--}}
{{--                                <span><a href="{{ $gallery->file_contents }}">ui elements</a><span class="slash-divider">/</span><a href="{{ $gallery->file_contents }}">media</a></span>--}}
                            </div>
                            <div class="port-btn-cont text-center">
                                <a href="{{ $gallery->file_contents }}"  target="_blank" class="lightbox mr-20" ><span class="icon_search"></span> PREVIEW</a>
{{--                                <a href="{{ $gallery->file_contents }}"><div aria-hidden="true" class="icon_link"></div></a>--}}
                            </div>
                        </div>
                    </li>
                @endforeach
